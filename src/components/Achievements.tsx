...
const achievements = [
  ...
  {
    id: 3,
    image: '/assets/images/clubs_analysed.png',
    title: '109+ clubs analysed',
  },
  {
    id: 4,
    image: '/assets/images/20Player_in_cyprus.png',
...
const Achievements = () => {
  ...
  return (
    <section className="relative w-full bg-black py-12 sm:py-20 lg:py-20">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 sm:px-6 lg:flex-row lg:items-center lg:gap-16 lg:gap-12">
